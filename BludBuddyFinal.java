...
class Login implements Colorcode
{
	...
	void registration()
	{
		while (true) 
		{
			...
			{
				System.out.println(RED+"* * * Invalid Input please enter a 10-digit mobile number starting with 8,9,7 or 6 * * * "+RESET);
			}
		}
...
interface City extends Colorcode
{
	static void hapov()
	{
		System.out.println("Currently available Donor details are here, You can contact them directly by contact number.");
		System.out.println(YELLOW+"----------------------------------------------------"+RESET);
			...
			else
			{
					...
					else if(cov=='2')
					{
						...
						if(srn.equals("yes"))
						{
							...
							if(day2<90 && tod=='1')
							{
								System.out.println(RED+"Your Not eligible Now. You can donate the blood after "+(90-day2)+" days ");
								k=k+1;
							}
							else if(day2<45&& tod=='2')
							{
								System.out.println("Your Not eligible Now. You can donate the Plasma after "+(45-day2)+" days ");
								k=k+1;
							}
							else if(day2<45&& tod=='3')
							{
								System.out.println("Your Not eligible Now. You can donate the Platelets after "+(45-day2)+" days "+RESET);
								k=k+1;
							}
						}
					...
					{					
						...
						else
						{
							...
							{
								System.out.println(REDBRI+"Your data has been saved. You might get a call from the person who needs you. Thank you."+RESET);
								System.out.println();
								System.out.println(CYAN+"If You Want To Donate today, You can donate at bloodbanks in your city."+RESET);
								//int opt=cs.nextInt();
								if(ct=='1')
								{
									hdetails();
...
class reg2 extends A implements Colorcode
{
	...
	{
System.out.println(BLINK+YELLOW+"	*     * ****** *      ***** ****  *     *  *****    ***** ****      ****   *     *    *  ****   ****    *    *   ***    ****   *       * "+RESET);
System.out.println(BLINK+YELLOW+"	*     * *      *      *     *  *  **   **  *          *   *  *      *   *  *     *    *  *   *  *   *   *    *   *   *  *   *   *     *   "+RESET);          
System.out.println(BLINK+YELLOW+"	*     * *      *      *     *  *  * * * *  *          *   *  *      *   *  *     *    *  *   *  *   *   *    *   *   *  *   *    *   *"+RESET);
System.out.println(BLINK+YELLOW+"	*  *  * *****  *      *     *  *  *  *  *  *****      *   *  *      ****   *     *    *  *    * ****    *    *   *    * *    *     *"+RESET);
System.out.println(BLINK+YELLOW+"	* * * * *      *      *     *  *  *     *  *          *   *  *      *   *  *     *    *  *   *  *   *   *    *   *   *  *   *     *"+RESET);
